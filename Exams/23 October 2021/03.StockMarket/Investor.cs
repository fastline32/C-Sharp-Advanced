...
namespace StockMarket
{
    public class Investor
    {
        ...
        {
            if (!Portfolio.ContainsKey(stock.CompanyName) && stock.MarketCapitalization > 10000 &&
        ...
        public Stock FindStock(string companyName) => Portfolio.FirstOrDefault(x => x.Key == companyName).Value;

        public Stock FindBiggestCompany() =>
            Portfolio.OrderByDescending(x => x.Value.MarketCapitalization).FirstOrDefault().Value;
